...
public class OpenhabGateway {
	...
	static ContainerManagerInterface containerManager = BundleFactory.getContainerManager();
		...
		*/
		...
		try {
			...
			DeviceContainer devCont = BundleFactory.getContainerManager()
					.getDeviceContainer(deviceContainerID);

			// sending the commands
			BundleFactory.getContainerManager().sendCommand(
					new DoubleCommand(newValue), deviceContainerID);

			devCont = BundleFactory.getContainerManager()
					.getDeviceContainer(deviceContainerID);
