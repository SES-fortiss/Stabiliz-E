...
//			kSession.fireAllRules();
	...
	@Override
	public void onDoubleEventReceived(DoubleEvent ev, String containerId, String client) {
...
//		}
		...
		execute();
		logger.info("Event value "+ ev.getValue()+ " from Device ContainerID " + containerId);
	}
	...
	public void onComplexDoubleEventReceived(HashMap<String, DoubleEvent> events, String client)
		...
		for (String key : events.keySet()) {
			onDoubleEventReceived(events.get(key), key, client);
		}
	}
