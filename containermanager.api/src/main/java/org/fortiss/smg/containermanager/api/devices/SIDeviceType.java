...
public enum SIDeviceType {
	...
	ConsumptionPowermeterWattAmp(SIUnitType.WA),
	ConsumptionPowermeterVoltAmp(SIUnitType.VA),
	ConsumptionPowermeterVoltAmpreactive(SIUnitType.VAR),
	PhaseVolt(SIUnitType.DEG),
	PowerFactor(SIUnitType.Numeric),
	
	ConsumptionActiveEnergyAggregated(SIUnitType.WA), //clarify
	ConsumptionApparentEnergyAggregated(SIUnitType.VA), //clarify
	ConsumptionReactiveEnergyAggregated(SIUnitType.VAR), //clarify
	
	ConsumptionActiveEnergy(SIUnitType.WA), //clarify
	ConsumptionApparentEnergy(SIUnitType.VA), //clarify
	ConsumptionReactiveEnergy(SIUnitType.VAR), //clarify
