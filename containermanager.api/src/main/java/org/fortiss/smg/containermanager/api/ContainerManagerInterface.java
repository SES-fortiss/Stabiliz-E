...
public interface ContainerManagerInterface extends HealthCheck {
	...
	/**
	 * this method returns a list of all (currently) registered devices. The list only contains the 
	 * ContainerIDs of the registered devices or an empty list.
	 * @return ArrayList<String> ContainerID, ContainerID, ...
	 * @throws TimeoutException
	 */
	public ArrayList<String> getRegisteredDevices() throws TimeoutException;
	...
	/** 
	 * Gets the human readable name (eg. "1001, Dijkstra Konferenzraum") of the room where the raspberry with the given mac adress is located.
	 */
	 ...
	 */
	public String addContainer(Container con) throws TimeoutException;
	public String addContainer(ContainerType containertype) throws TimeoutException;
	public String addDevContainer(DeviceContainer con) throws TimeoutException;
	...
	public void sendCommand(DoubleCommand command, String containerId) throws TimeoutException;
	 ...
	 * @throws TimeoutException
	 */
	boolean registerListener(String clientName, String queueName) throws TimeoutException;
	
	boolean unregisterListener(String queueName) throws TimeoutException;
	
	/**
	 * used to enforce updating the registered devices and e.g. inform listeners
	 */
