...
public class DeviceContainerSpec {
	...
	//TODO Check if we need containerId
	...
	public HashMap<String, Object> serialize() {
		...
		deviceSpec.put("deviceid", deviceId);
		//deviceSpec.put("internparent", internDeviceParent);
		deviceSpec.put("containerId", containerId);
		deviceSpec.put("devid", devId);
		deviceSpec.put("wrapperId", wrapperId);
	...
	public void deserialize(HashMap<String, Object> deviceSpec) {
		...
		if (deviceSpec.containsKey("containerId")) {
			this.containerId = deviceSpec.get("containerId").toString();
		}
		
		if (deviceSpec.containsKey("devid")) {
			this.devId = deviceSpec.get("devid").toString();
		}
		
		if (deviceSpec.containsKey("wrapperid")) {
			this.wrapperId = deviceSpec.get("wrapperid").toString();
		}
