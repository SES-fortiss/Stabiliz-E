...
public interface IActuatorMaster extends HealthCheck {
	 ...
	 * @throws TimeoutException
	 */
	void sendDoubleCommand(DoubleCommand command, String containerId) throws TimeoutException;
	 ...
	 * @throws TimeoutException
	 */
	void sendDoubleEvent(DoubleEvent ev, String containerID, String client) throws TimeoutException;
	
	void sendComplexDoubleEvent(HashMap<String, DoubleEvent> events, String client) throws TimeoutException;
	 ...
	 * @throws TimeoutException
	 */
	String sendDeviceEvent(DeviceEvent ev, String client) throws TimeoutException;
	
	/**
	 * client saw an new device (or update) and sends it to the master
	 */
	ArrayList<Triple<String, DoubleEvent, Long>> getLatestNumber(int number) throws TimeoutException;
