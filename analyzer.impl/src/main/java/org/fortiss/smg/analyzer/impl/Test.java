...
public class Test {
	...
	public static void testDeviceComparePercent(
			InformationBrokerInterface broker, ContainerManagerInterface containerManager) throws TimeoutException {
		Calendar start = Calendar.getInstance();
		Calendar stop = Calendar.getInstance();
		start.set(2013, 11, 1, 0, 0, 0);
		stop.set(2013, 11, 2, 0, 0, 0);

		DataSet outside = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.CELSIUS.toString(), "enoceanQ?0003B078")));
		DataSet meetingRoom = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.CELSIUS.toString(), "enoceanQ?010066F4_Actual")));
		DataSet room2 = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.CELSIUS.toString(), "enoceanQ?01003E48_Actual")));
		DataSet solar = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
		...
		HashMap<String, Double> finish = Comparison.deviceComparePercent(
	...
	public static void testDeviceCompareFraction(
		...
		DataSet westWingSicherung = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "siemensQ153?C2/MMXU1.TotW.mag.mag")));
		DataSet westWingSwitch = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "siemensQ153?C4/MMXU1.TotW.mag.mag")));
		DataSet eastWingSicherung = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "siemensQ153?C1/MMXU1.TotW.mag.mag")));
		DataSet eastWingSwitch = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "siemensQ153?C3/MMXU1.TotW.mag.mag")));
		DataSet server = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "siemensQ?C1/MMXU1.TotW.mag.mag")));
		DataSet total = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
		...
		System.out.println("Stop Date: " + stop.getTime().toString());
		System.out.println("Start Date: " + start.getTime().toString());
		HashMap<String, Double> finish = Comparison.deviceCompareFraction(
	 ...
	 *            database connection
	 */
	public static void testTimeCompare(InformationBrokerInterface broker, ContainerManagerInterface containerManager)
			throws TimeoutException {
		Calendar start = Calendar.getInstance();
		Calendar stop = Calendar.getInstance();
		...
		DataSet dezember = new DataSet(start.getTimeInMillis(), stop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "acc.VPowerTracker1")));
		try {
		...
		DataSet november = new DataSet(startNov.getTimeInMillis(), stopNov.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.W.toString(), "acc.VPowerTracker1")));
		try {
	 ...
	 * @param broker
	 */
	public static void selfComp(InformationBrokerInterface broker, ContainerManagerInterface containerManager)
			throws TimeoutException {
		...
		DeviceId tempdev = new DeviceId(SIUnitType.CELSIUS.toString(),
				"enoceanQ?0003B078");
		String containerId = containerManager.getContainerId(tempdev);
		ArithmeticMean arith = new ArithmeticMean();

		DataSet temp = new DataSet(tempstart.getTimeInMillis(), tempstop.getTimeInMillis(), containerId);
		try {
		...
		DataSet temp2 = new DataSet(temp2start.getTimeInMillis(), temp2stop.getTimeInMillis(), containerId);
		try {
	 ...
	 *            TrendAnalyzer
	 */
	public static void plotterQuantile(InformationBrokerInterface broker, ContainerManagerInterface containerManager)
			throws TimeoutException {
		Calendar tempStart = Calendar.getInstance();
		Calendar tempStop = Calendar.getInstance();
		...
		DataSet temperaturData = new DataSet(tempStart.getTimeInMillis(), tempStop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.CELSIUS.toString(), "enoceanQ?0003B078")));
		try {
	...
	// TODO: comment
	public static void interpolateSpilne(InformationBrokerInterface broker, ContainerManagerInterface containerManager)
			throws TimeoutException {
		Calendar tempStart = Calendar.getInstance();
		Calendar tempStop = Calendar.getInstance();
		tempStart.set(2013, 8, 1, 00, 15, 13);
		...
		DataSet temperature = new DataSet(tempStart.getTimeInMillis(), tempStop.getTimeInMillis(), containerManager.getContainerId(new DeviceId(
				SIUnitType.CELSIUS.toString(), "enoceanQ?0003B078")));
		try {
	...
	// TODO: comment
	public static void sqlTest(InformationBrokerInterface broker, ContainerManagerInterface containerManager)
			throws TimeoutException {
	...
	// TODO comment
	public static void classifyAll(InformationBrokerInterface broker, ContainerManagerInterface containerManager,
