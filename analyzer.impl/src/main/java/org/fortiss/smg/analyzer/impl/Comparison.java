...
public class Comparison {
	 ...
	 */
	public static HashMap<String, Double> deviceCompareFraction(
	 ...
	 *         {@code null} will be the value of this fraction.
	 */
	public static HashMap<String, Double> deviceCompareAbsolute(
			DataSet reference, List<DataSet> comparer,
			CalculationMethods aggregationMethode) {
	 ...
	 *         {@code null} will be the value of this fraction.
	 */
	public static HashMap<String, Double> deviceComparePercent(
			DataSet reference, List<DataSet> comparer,
			CalculationMethods aggregationMethode) {
	 ...
	 *             or an empty list
	 */
	private static HashMap<String, Double> deviceCompare(DataSet total,
			...
			if (currentSet == null) {
				...
				try {
					barChartSet = new DataSet(currentSet.getStartDate(),
							currentSet.getStopDate(), currentSet.getContainerId(),
